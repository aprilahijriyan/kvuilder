...
<MDSwiperPagination>
    ...
    MDIconButton:
        ...
        theme_text_color: 'Custom'
        text_color: app.theme_cls.primary_color
        on_release: root.manager.switch_screen('right')
    ...
    MDIconButton:
        ...
        text_color: app.theme_cls.primary_color
        icon: 'chevron-right'
        on_release: root.manager.switch_screen('left')
"""
)
...
class MDSwiperManager(ScreenManager):
    ...
    def __init__(self, **kwargs):
        ...
        def init_paginator(*args):
            self.paginator.ids.prev_btn.disabled = True

        self.bind(paginator=init_paginator)
    ...
    def switch_handler(self, *args):
        root = self.paginator.ids
        prev_btn = root.prev_btn
